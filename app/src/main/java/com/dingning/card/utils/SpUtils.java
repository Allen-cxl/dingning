...
/**
 * SharedPreference操作类
 * Created by xialo on 2016/6/13.
 */
public class SpUtils {
    private static final String spFileName = "dingning_dzbp";
    public static final String spClassName = "class_name";
    public static final String spSchoolName = "school_name";
    public static final String spSchoolLogo = "school_logo";
    public static final String spClassID = "class_id";
    public static final String spAdminPassword = "admin_password";
