package com.dingning.card.weight;
...
public class RecordView extends View {
    ...
    private int countdownTime = 30;//倒计时时间，默认时间30秒
    private int countdownTime2 = 30;//倒计时时间，默认时间30秒.这是会变的
...
//                Log.d(TAG,"progress:"+progress);
    ...
    private void initAtts() {
        ...
        timeTextColor = typedArray.getColor(R.styleable.recordView_timeTextColor, getResources().getColor(R.color.pink_dark));
    ...
    private void drawDefaultView(Canvas canvas) {
        ...
        if (hintText != null && !hintText.equals("")) {
            ...
            paint.setColor(mContext.getResources().getColor(R.color.pink_dark));
            ...
            // 下面这行是实现水平居中，drawText对应改为传入targetRect.centerX()
            paint.setTextAlign(Paint.Align.CENTER);
            canvas.drawText("录制时间", getWidth() / 2, getHeight() / 2 + 50, paint);
        }
        ...
        paint2.setColor(mContext.getResources().getColor(R.color.pink_dark));
        paint2.setTextAlign(Paint.Align.CENTER);
        ...
        paint1.setColor(mContext.getResources().getColor(R.color.pink_dark));
